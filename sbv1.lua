...
elseif game.Players.LocalPlayer.Character:WaitForChild("isInArena").Value == true and game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart") then
